...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "healthz.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\rhealthz.proto\022\007healthz\"\024\n\022HealthCheckR"
      "equest\"\025\n\023HealthCheckResponse2^\n\022HealthC"
      "heckService\022H\n\013HealthCheck\022\033.healthz.Hea"
      "lthCheckRequest\032\034.healthz.HealthCheckRes"
      "ponseB\003\200\001\001b\006proto3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 178);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "healthz.proto", &protobuf_RegisterTypes);
}
...
HealthCheckRequest::HealthCheckRequest()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_healthz_2eproto::scc_info_HealthCheckRequest.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* HealthCheckRequest::descriptor() {
  ::protobuf_healthz_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_healthz_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const HealthCheckRequest& HealthCheckRequest::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_healthz_2eproto::scc_info_HealthCheckRequest.base);
...
::google::protobuf::Metadata HealthCheckRequest::GetMetadata() const {
  protobuf_healthz_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_healthz_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
HealthCheckResponse::HealthCheckResponse()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_healthz_2eproto::scc_info_HealthCheckResponse.base);
  SharedCtor();
...
const HealthCheckResponse& HealthCheckResponse::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_healthz_2eproto::scc_info_HealthCheckResponse.base);
  return *internal_default_instance();
}
...
const ::google::protobuf::ServiceDescriptor* HealthCheckService::descriptor() {
  protobuf_healthz_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_healthz_2eproto::file_level_service_descriptors[0];
}
...
void HealthCheckService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), protobuf_healthz_2eproto::file_level_service_descriptors[0]);
  switch(method->index()) {
    case 0:
