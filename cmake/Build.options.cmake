...
if (ENABLE_FFMPEG)
  ...
  if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/third_party/ffmpeg-v5.1.2/include)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/third_party/ffmpeg-v5.1.2/include)
    link_directories(${CMAKE_CURRENT_SOURCE_DIR}/third_party/ffmpeg-v5.1.2/lib)
  elseif (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/third_party/ffmpeg/ffmpeg/include)
  ...
  elseif (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/third_party/ffmpeg/include)
    ...
    message(WARNING "FFmpeg include directory not found, video features may not work")
  endif()
endif()

option(ENABLE_CPP_HTTPLIB "ENABLE_CPP_HTTPLIB" ON)
if (ENABLE_CPP_HTTPLIB)
  if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/third_party/cpp-httplib)
    message(STATUS "> build with cpp-httplib")
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/third_party/cpp-httplib)
  endif()
endif()

option(ENABLE_LIBCO "ENABLE_LIBCO" OFF)
if (ENABLE_LIBCO)
  message(STATUS "> build with libco lib")
  add_definitions(-DENABLE_LIBCO)
  set(LIBCO_DEPS colib)
  include_directories(${CMAKE_CURRENT_SOURCE_DIR}/third_party/libco-v1.0/include)
  link_directories(${CMAKE_CURRENT_SOURCE_DIR}/third_party/libco-v1.0/lib)
endif()
